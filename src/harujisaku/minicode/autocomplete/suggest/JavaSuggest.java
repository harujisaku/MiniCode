...
public class JavaSuggest extends AbstractSuggest{
	...
	/**
	* javaでよく使う単語である</br>
	* "abstract  ","break;","catch","class ","case","default","do","else","final ","for","finally","if","import ","interface ","print","println","private ","protected ","public ","return ","static ","throw","try","void ","while","package"</br>
	を定義済みです.
	*/
